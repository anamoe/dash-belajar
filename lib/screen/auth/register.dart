...
class _RegisterState extends State<Register> {
  ...
  var email, password,username,nohp,nohp_ortu;
          ...
          child: Column(
            children: [
              Align(
                ...
                child: Image.asset("assets/icon/logo.png",width: 180,),
              ),
              Align(
                alignment: Alignment.center,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                            ...
                            validator: (nohpValue) {
                              if (nohpValue.isEmpty) {
                                return 'Please enter your No. Handphone';
                              }
                              nohp = nohpValue;
                              return null;
                            }),
                        ...
                        TextFormField(
                            ...
                            keyboardType: TextInputType.text,
                            decoration: InputDecoration(
                                hintText: "No. Handphone Orangtua",
                                hintStyle: TextStyle(color: Colors.white),
                                border: OutlineInputBorder(),
                                contentPadding: const EdgeInsets.symmetric(
                                    vertical: 1.0, horizontal: 5)),
                            validator: (nohportuValue) {
                              if (nohportuValue.isEmpty) {
                                return 'Please enter your No. Handphone Orangtua';
                              }
                              nohp_ortu = nohportuValue;
                              return null;
                            }),
                        SizedBox(height: 12),
  ...
  void _register() async {
    ...
    var data = {'email': email, 'password': password,'no_hp':nohp,'no_hp_ortu':nohp_ortu,'nama_lengkap':username};
